...
python preprocess_data.py --raw_data_path green-taxi-data --dest_path ./output
```
...
```
/workspaces/mlops-zoomcamp/02-experiment-tracking/homework (main) $ python train.py
/workspaces/mlops-zoomcamp/02-experiment-tracking/homework (main) $ mlflow ui
```
